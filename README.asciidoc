...
Right now a lot to read. And like the telephone book of old, you really just read the parts you need. So jump to what you need from the table of contents or search it. The stuff was writen more for me anyway.
...
- Check whether SPI and I2C are enabled on the Pi, offer to enable them and reboot when necessary; the script will wait for the Pi to come back online and resume automatically
