...
The following images show why it might not be bad to have different cameras connected to a pi microscope se
...
ng a plastic mount right next to a heat source)
====
